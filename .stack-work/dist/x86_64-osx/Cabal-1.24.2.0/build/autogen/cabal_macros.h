...
/* package testResults-0.1.0.0 */
#define VERSION_testResults "0.1.0.0"
#define MIN_VERSION_testResults(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "testResults-0.1.0.0-7TYFrrF6jiYHWiuvmXG8vd"

#define CURRENT_PACKAGE_KEY "testResults-0.1.0.0-7TYFrrF6jiYHWiuvmXG8vd"
